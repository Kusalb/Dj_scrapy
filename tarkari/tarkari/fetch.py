...
try:
    ...
    for row in records:
        if (i < 33):
            ...
            draw.text((1250, (500 + i * 80)), row[2], (0, 0, 0), font=font)
            draw.text((1600, (500 + i * 80)), row[3], (0, 0, 0), font=font)
    ...
    for row in records:
        if (j >= 33):
            ...
            draw1.text((1250, (-2150 + j * 80)), row[2], (0, 0, 0), font=font)
            draw1.text((1600, (-2150 + j * 80)), row[3], (0, 0, 0), font=font)
    ...
    im1.save("marked_image1.png")
    im2.save("marked_image2.png")
